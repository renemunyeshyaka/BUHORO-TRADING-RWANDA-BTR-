...
<body class="login2">
	...
	<div class="login-wrapper">
		<a href="http://phonecomltd.com" target="_blank">
				<img src="imgs/logo.png" width="120px" height="63px">
			 </a>
	...
	if($pto==31){
		print("<div class='alert alert-danger' style='border-radius:5px;'>
		<i class='lnr lnr-sad'></i> <button class='close' data-dismiss='alert' type='button'>×</button>The Email you entered is not found.
		</div>");
	}
	if($pto==32){
		print("<div class='alert alert-danger' style='border-radius:5px;'>
