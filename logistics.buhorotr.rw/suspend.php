...
$do=mysql_query("SELECT *FROM $tbl WHERE `Eid`!='1001' AND `Status`='1' $conde $condi ORDER BY `Depart` ASC $cond");
...
if($reba!=$dep AND $n!='1')
print("<tr><td colspan='11' style='background-color:#66ff00;'> </td></tr>");
