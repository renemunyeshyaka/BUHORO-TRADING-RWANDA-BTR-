...
$perpagevalue=100;
$cond="ORDER BY `Fname` ASC LIMIT $perpagevalue";
$conde=" AND `Status`='0'";
$condi='';
...
if(isset($_POST['submitfilter']))
		...
		if($_SESSION['Depa']=='1' OR $_SESSION['Depa']=='2'){
...
$do=mysql_query("SELECT *FROM `employees` WHERE `Eid`!='1001' $conde $condi $cond");
...
$sl='';
			echo"<option value='$ne' $sed $sl>$dep</option>";
			  }
			  ?>                      
                      </select><br>
        ...
        <form action="" method="post" class="form-horizontal">
                      ...
                      <input class="form-control" name="searchkeyword" placeholder="search" type="text" id="searche">
            ...
            <div class="widget-content padded clearfix">
                    ...
                    <tr role="row">
                     <th class="hidden-xs"> No </th>
					   ...
					   <th class="hidden-xs"><center> Position </th>
					   <th class="hidden-xs"><center> Salary </th>
...
$so=mysql_query("UPDATE `employees` SET `Fullname` = '$name' WHERE `Eid` = '$code'");

	print("<tr><td $stn class='hidden-xs text-center'> $n </td>
	<td $stn> $fna</td><td $stn> $lna</td>
	<td $stn class='hidden-xs'> $dep</td><td $stn align='right'> $cont</td>
	<td $stn class='hidden-xs' align='right'> $idn</td>
	<td $stn class='hidden-xs'> $adde</td>
	<td $stn class='hidden-xs'> $pos</td>
	<td $stn class='hidden-xs text-right'> $sala </td>
	
	  <td  align='right' style='width:40px;padding:0px;'><div class='action-buttons'>
                                                <a class='table-actions' href='$lin'>View</a></td>

						<form method=post action='new_employee.php'><td align='right' style='width:40px;padding:0px;'>
                        <input type='hidden' name='rowid' value='$code'>
                           <button style='background-color:transparent;border:0px solid black; width:40px; margin:0px;' type='$lne' name='edit_id'>
