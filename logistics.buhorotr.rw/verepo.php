<?php
if(basename($_SERVER['PHP_SELF']) == 'verepo.php') 
  $cm=" class='current'";
include'header.php';
...
$do=mysqli_query($conn, "SELECT *FROM `vehicles` WHERE `Status`='0' AND `Trip`='1' $conde ORDER BY `Number` ASC LIMIT 100");
...
<div class="container-fluid main-content">
  ...
  <ul class="list-group">   
	...
	$upd1=mysqli_query($conn, "UPDATE `trips` SET `Driver`='$driver' WHERE `Vehicle`='$code' AND `Driver`=''");
	
	$upd2=mysqli_query($conn, "UPDATE `repair` SET `External`='$trip' WHERE `Vehicle`='$code'");
	
	$upd3=mysqli_query($conn, "UPDATE `income` SET `External`='$trip' WHERE `Vehicle`='$code'");
	
	$upd4=mysqli_query($conn, "UPDATE `consumption` SET `External`='$trip', `Plate`='$vid' WHERE `Vehicle`='$code'");
