<?php
if(basename($_SERVER['PHP_SELF']) == 'cashrepo.php') 
  $cm=" class='current'";
include'header.php';
  ...
  <div class="col-lg-2 hidden-print">
    ...
    <li class="list-group-item">
	  ...
	  <span class="input-group-addon"><i class="lnr lnr-calendar-full"></i></span>
               ...
               <?php
				if($p)
		$dok=mysqli_query($cons, "SELECT *FROM `payment` WHERE `Status`='0' AND `Date` BETWEEN '$dato' AND '$datos' AND `Action`='CASHBOX' ORDER BY `Date` ASC LIMIT 1000");
				else
		$dok=mysqli_query($cons, "SELECT *FROM (SELECT *FROM `payment` WHERE `Status`='0' AND `Date` <= '$Date' AND `Action`='CASHBOX' ORDER BY `Date` DESC LIMIT 10) SUB ORDER BY `Date` ASC");
            ...
            <div class="widget-content padded clearfix">
                    ...
                    <tr role="row">
					 ...
					 <th width='8%' style='padding:1px;'>&nbsp;&nbsp;&nbsp;Date </th>
                       <th style='padding:1px;'>&nbsp;&nbsp;Done By </th><th style='padding:1px;'>&nbsp;&nbsp;&nbsp;&nbsp;Description </th>
					   <th style='padding:1px;'>&nbsp;&nbsp;&nbsp;Mode of Payment </th>
			...
			$doi=mysqli_query($cons, "SELECT *FROM `baccount` WHERE `Number`='$bna' ORDER BY `Number` ASC");
			...
			$stl="padding:1px;";
				...
				print("<tr><td width='5%' class='hidden-xs' style='$stl $clr'><div align='right'>$i&nbsp;&nbsp;</td>
						<td style='$stl $clr'><div align='center'>&nbsp;$dte&nbsp;</td><td style='$stl $clr'>&nbsp; $sour </td>
						<td style='$stl $clr'>&nbsp; $dest </td><td style='$stl $clr'><div align='left'> $mode &nbsp;&nbsp; $cno &nbsp; $fna &nbsp; $acco</td>
					 ...
					 <thead>
					<tr><th class='hidden-xs'> </th><th colspan='4'><div align='center'> Total Amount </th><th><div align='right'><?php echo $tp ?></th>
								</tr></table><br><br>
								</div></div>
