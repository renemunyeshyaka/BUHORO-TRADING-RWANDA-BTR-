<?php
if(basename($_SERVER['PHP_SELF']) == 'withrepo.php') 
  $cm=" class='current'";
include'header.php';
    ...
    <li class="list-group-item">
	  ...
	  <span class="input-group-addon"><i class="lnr lnr-calendar-full"></i></span>
		...
		$dok=mysqli_query($cons, "SELECT *FROM (SELECT *FROM `deposit` WHERE `Status`='0' AND `Date` <= '$Date' AND `Item`!='DEPOSIT' $conde ORDER BY `Number` DESC LIMIT 20) SUB ORDER BY `Date` ASC");
             ...
             <div class="divFooter"><center><u><b>WITHDRAWAL REPORT <?php echo $mpri ?></b></u></center></div>
             <div class="row">
            <div class="col-lg-12">
			...
			$stl="padding:1px;";
				...
				print("<tr><td class='hidden-xs' style='$stl $clr'><div align='center'>$i&nbsp;&nbsp;</td>
