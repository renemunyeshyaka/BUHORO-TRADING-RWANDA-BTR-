...
<body class="login2">
	...
	<div class="login-wrapper">
		<a href="#" target="_blank" class="hidden-xs">
				<img src="imgs/logo.png" width="120px" height="83px" style="border-radius:5px;">
			 </a><br>
	...
	<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon"><i class="lnr lnr-users"></i></span><input class="form-control" placeholder="Username or Email" name="email" type="text" autofocus='autofocus' required>
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
